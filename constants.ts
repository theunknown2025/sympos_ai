import { Submission, SubmissionStatus, ConferenceConfig } from './types';

export const MOCK_SUBMISSIONS: Submission[] = [
  {
    id: 'SUB-001',
    title: 'Deep Learning Approaches in genomic sequencing for rare diseases',
    author: 'Dr. Sarah Chen',
    institution: 'MIT',
    abstract: 'This paper explores novel transformer-based architectures for rapid genomic sequencing, focusing on error reduction in long-read technologies. We propose a hybrid model that combines CNNs for local feature extraction with attention mechanisms for global context.',
  ...
  {
    id: 'SUB-002',
    title: 'Ethical Implications of AI in Public Administration',
    author: 'James Miller',
    institution: 'Oxford University',
    abstract: 'As governments increasingly adopt AI for decision-making, questions of bias and accountability arise. This study surveys 50 public sector implementations.',
    track: 'AI Ethics',
    status: SubmissionStatus.SUBMITTED,
    submittedDate: '2023-10-18',
    files: ['draft_v1.pdf', 'data.zip']
  },
  {
    id: 'SUB-003',
    title: 'Quantum Computing: A New Era for Cryptography',
    author: 'Elena Rossi',
    institution: 'ETH Zurich',
    abstract: 'Post-quantum cryptography is no longer theoretical. We present a lattice-based encryption scheme that remains secure against Shor\'s algorithm.',
    track: 'Computer Science',
    status: SubmissionStatus.ACCEPTED,
    submittedDate: '2023-09-20',
    files: ['final_paper.pdf']
  },
  {
    id: 'SUB-004',
    title: 'Sustainable Energy Grid Optimization using Reinforcement Learning',
    author: 'David Kim',
    institution: 'KAIST',
    abstract: 'Optimizing the distribution of renewable energy sources in a smart grid using multi-agent reinforcement learning.',
    track: 'Energy',
...
export const INITIAL_CONFERENCE_CONFIG: ConferenceConfig = {
  title: 'International Conference on Future Tech 2024',
  date: '2024-06-15',
  location: 'San Francisco, CA',
  description: 'Join leading researchers and innovators to discuss the future of technology.',
  header: {
    showLogo: true,
    showTitle: true,
  ...
  hero: {
    ...
    buttons: [
      ...
      { id: 'btn-2', text: 'Submit Paper', url: '#submit', style: 'secondary' }
    ]
  },
  speakers: [
    {
  ...
  team: [
    {
      ...
      bio: 'With over 10 years of experience in event management, Sarah ensures every detail of the conference runs smoothly. She specializes in large-scale academic conferences and has a passion for creating memorable experiences.',
      imageUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
      links: [
    ...
    },
    {
      ...
      bio: 'Michael leads the technical infrastructure for the conference, managing everything from web platforms to on-site AV systems. He has a background in software engineering and event technology.',
      imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
      links: [
    ...
    },
    {
      ...
      bio: 'Emma brings creative energy to conference promotion and branding. She has successfully marketed over 50 academic and professional events, with expertise in digital marketing and social media strategy.',
      imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
      links: [
        { id: 't3-l1', platform: 'linkedin', url: '#' },
        { id: 't3-l2', platform: 'twitter', url: '#' },
        { id: 't3-l3', platform: 'instagram', url: '#' }
      ]
    }
  ],
  agenda: [
      ...
      items: [
        {
          ...
          description: 'Pick up your badges and networking.',
          location: 'Main Lobby'
        },
        {
          id: 'item-2',
  ...
  pricing: [
    ...
    },
    {
      ...
      price: '399',
      currency: '$',
      features: ['Full Conference Access', 'Workshops Included', 'Lunch & Refreshments', 'Certificate of Attendance', 'Gala Dinner Entry'],
...
export const MOCK_REGISTRATIONS_DATA = [
  { name: 'Jan', attendees: 40 },
  { name: 'Feb', attendees: 80 },
  { name: 'Mar', attendees: 150 },
  { name: 'Apr', attendees: 220 },
  { name: 'May', attendees: 340 },
  { name: 'Jun', attendees: 480 },
];