...
export const routes: Record<ViewState, string> = {
  ...
  [ViewState.PROGRAM_BUILDER]: '/submissions/program-builder',
  ...
  [ViewState.ENTITY_PROFILE]: '/entity-profile',
  [ViewState.ACADEMY_LMS]: '/academy-lms',
  [ViewState.ACADEMY_COURSE_MANAGER]: '/academy-lms/courses',
  [ViewState.ACADEMY_ENROLLMENT_MANAGER]: '/academy-lms/enrollments',
  [ViewState.ACADEMY_PAYMENT_MANAGER]: '/academy-lms/payments',
  ...
  [ViewState.CV_BUILDER]: '/jury/tools/cv-builder',
  [ViewState.PROFILE_BUILDER]: '/jury/tools/profile-builder',
  [ViewState.PARTICIPANT_BLOG]: '/jury/tools/blog',
  [ViewState.PARTICIPANT_ACADEMY]: '/jury/academy',
  [ViewState.PARTICIPANT_ACADEMY_COURSES]: '/jury/academy/courses',
  [ViewState.PAIEMENT_MANAGEMENT]: '/paiement-management',
  [ViewState.PAIEMENT_INFORMATION]: '/paiement-management/information',
  [ViewState.NEW_PAIEMENT]: '/paiement-management/new',
  [ViewState.LISTE_OFFERS]: '/paiement-management/offers',
  [ViewState.PAIEMENT_FOLLOW_UP]: '/paiement-management/follow-up',
