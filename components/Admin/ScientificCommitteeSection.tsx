...
const ScientificCommitteeSection: React.FC<ScientificCommitteeSectionProps> = ({ members, title = "Scientific Committee" }) => {
  return (
    <div className="py-24 px-8 bg-white border-t border-slate-100">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center p-2 bg-indigo-50 rounded-lg mb-4 text-indigo-600">
             <Award size={24} />
          </div>
