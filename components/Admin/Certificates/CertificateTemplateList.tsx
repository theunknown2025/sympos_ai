...
import { FileText, Edit, Eye, Trash2, Loader2, Plus } from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col p-8">
      <header className="mb-6">
        ...
        <p className="text-slate-500 mt-1 text-sm">Manage your certificate templates</p>
      </header>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center h-64 bg-white rounded-xl border border-slate-200">
          ...
          <p className="text-slate-500 mb-4">Create your first certificate template</p>
          <button
            onClick={handleNew}
