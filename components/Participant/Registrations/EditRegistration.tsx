...
const EditRegistration: React.FC<EditRegistrationProps> = ({ submission, onClose, onSuccess, onDelete }) => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to update registration. Please try again.');
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Edit Registration</h2>
